...
A magnetic field line is integrated using $\dfrac{\textrm{d} \vec{r}(s)}{\textrm{d} s}=\dfrac{\vec{B}}{B}$
  ...
  * **inclineFlag**: to apply Equation (20) or (21) in [Zhang (2022)]((https://iopscience.iop.org/article/10.3847/1538-4357/ac8d61)): $step_{S_0}=$
  $\texttt{step|}_{S_0} = \textrm{max}([step_{\perp} \times |B_{n,0} / B|, step_\textrm{min}])$
